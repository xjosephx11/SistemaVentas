...
namespace CapaPresentacion
{
    public partial class frmProveedores : Form
    {
        ...
        private void frmProveedores_Load(object sender, EventArgs e)
        {
            ...
            {
                dgvData.Rows.Add(new object[] { "", item.IdProveedor, item.Documento, item.RasonSocial, item.Correo, item.Telefono,
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            Proveedor objProveedor = new Proveedor()
            {
                ...
                RasonSocial = txtRazonSocial.Text,
            ...
            {
                //guardamos usuario
                int idgenerado = new CNProveedor().Registrar(objProveedor, out mensaje);
                ...
                if (idgenerado != 0)
                {
                    ...
                    MessageBox.Show("Proveedor registrado exitosamente!", "Exelente", MessageBoxButtons.OK);
                    limpiar();
                }
                else
                {
            ...
            else
            {
                ...
                if (resultado)
                {
                    ...
                    MessageBox.Show("Proveedor actualizado exitosamente!", "Exelente", MessageBoxButtons.OK);
                    limpiar();
                }
                else
                {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            {
                if (MessageBox.Show("¿Desea eliminar el proveedor?", "Mensaje",
                    MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    if (respuesta)
                    {
                        ...
                        MessageBox.Show("Proveedor eliminado exitosamente!", "Exelente", MessageBoxButtons.OK);
                        limpiar();
                    }
                    else
                    {
